...
<div class="page">
  ...
  <div class="body">
      <form id="gameForm" action="/submitTurn" method="POST">
          ...
          <div>  <!-- game-controls and board div-->
            <div id="game-controls">

                <fieldset id="game-info">
                    <legend>Info</legend>

                <#assign message = {"type":"TYPE", "text":"Heres is the message"}>
              ...
              </div><!-- End class="game-board" div -->

          </div>  <!--End  game-controls and board div-->
      </form>
  </div><!-- End class="body" div-->
</div>
